                        ...
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button
                                        type="button"
                                        wire:click="mountAction('approve', @js(['id' => $review->id, 'type' => $review->type, 'nickname' => $review->nickname]))"
                                    ...
                                    <button
                                        type="button"
                                        wire:click="mountAction('delete', @js(['id' => $review->id, 'type' => $review->type, 'nickname' => $review->nickname]))"
